...
<div class="mb-6">
    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Clinic Patients</h1>
    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Outpatient roster</p>
</div>
...
<div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
    <table class="w-full text-sm text-left text-gray-700 dark:text-gray-300">
        ...
        <tbody>
            ...
            <tr><td colspan="5" class="px-4 py-8 text-center text-gray-500 dark:text-gray-400">No clinic patients.</td></tr>
            <?php else: ?>
            ...
            <tr class="border-t border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                ...
                <td class="px-4 py-3"><?php echo !empty($p['last_visit']) ? date('M j, Y', strtotime($p['last_visit'])) : '—'; ?></td>
