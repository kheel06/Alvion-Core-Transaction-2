...
$page_title = 'Assigned Inpatients';
...
<div class="mb-6">
    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Assigned Inpatients</h1>
    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Ward and bed locations</p>
</div>
...
<div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
    <table class="w-full text-sm text-left text-gray-700 dark:text-gray-300">
        ...
        <tbody>
            ...
            <tr><td colspan="5" class="px-4 py-8 text-center text-gray-500 dark:text-gray-400">No inpatients assigned.</td></tr>
            <?php else: ?>
