...
$page_title = 'Consults';
$consults = doctorPortal_seedConsults();

include __DIR__ . '/../../includes/header.php';
?>

<div class="mb-6">
    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Consults</h1>
    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Requested and completed consults</p>
</div>
    ...
    <table class="w-full text-sm text-left text-gray-700 dark:text-gray-300">
        ...
        <tbody>
            ...
            <tr class="border-t border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                ...
                <td class="px-4 py-3"><?php echo htmlspecialchars($c['service']); ?></td>
                <td class="px-4 py-3"><?php echo htmlspecialchars($c['requested']); ?></td>
