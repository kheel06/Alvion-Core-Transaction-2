...
// Real data only – no sample data. When no wards/beds data, show empty state.
if (empty($ward_stats)) {
    $ward_stats = [];
    if (empty($current_occupancy)) {
        $current_occupancy = [
            'total_beds' => 0,
            'occupied_beds' => 0,
            'available_beds' => 0,
...
<div class="mb-6">
    ...
    <p class="text-gray-600 dark:text-gray-400">Hospital bed utilization and occupancy · Data from hospital system (Philippines)</p>
</div>
