...
if (!function_exists('getRoleDefinitions')) {
    function getRoleDefinitions(): array {
        ...
        $definitions = [
            ...
            'doctor' => [
                'label' => 'Doctor',
                'description' => 'Doctor portal access: chart, orders, prescribing, and clinical workflow.',
                'inherits' => [],
                'permissions' => ['doctor.portal', 'doctor.chart', 'doctor.orders', 'doctor.prescribe'],
            ],
            'attending' => [
                'label' => 'Attending',
                'description' => 'Attending physician: full privileges including discharge and controlled meds.',
                'inherits' => ['doctor'],
                'permissions' => ['doctor.discharge', 'doctor.controlled_meds', 'doctor.cosign'],
            ],
            'resident' => [
                'label' => 'Resident',
                'description' => 'Resident: notes require co-sign; restricted prescribing.',
                'inherits' => ['doctor'],
                'permissions' => ['doctor.portal', 'doctor.chart', 'doctor.orders'],
            ],
            'consultant' => [
                'label' => 'Consultant',
                'description' => 'Consultant physician: full clinical privileges.',
                'inherits' => ['doctor', 'attending'],
                'permissions' => ['doctor.discharge', 'doctor.controlled_meds', 'doctor.cosign'],
            ],
        ];
